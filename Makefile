...
$(TARGET): $(SRCDIR)/main.cpp $(SRCDIR)/config.hpp $(SRCDIR)/eth_control.hpp $(SRCDIR)/gatt_server.hpp $(SRCDIR)/relay_control.hpp $(SRCDIR)/victron_control.hpp $(SRCDIR)/wifi_control.hpp $(SRCDIR)/subprocess.hpp
